...
class ClickType : public Transform<bool, ClickTypes> {
 public:
   ...
   *
   */
  ClickType(String config_path = "", unsigned long long_click_delay = 1300,
            unsigned long double_click_interval = 400,
            unsigned long ultra_long_click_delay = 5000);
